...
public final class BingSpeechRecognizer implements SpeechProcessor {
     ...
     * @param componentConfig Spokestack speech configuration
     * @throws Exception on error
     */
    public BingSpeechRecognizer(ComponentConfig componentConfig) throws Exception {
        this(componentConfig, new BingSpeechClient.Builder());
    }
    ...
    public BingSpeechRecognizer(
        ...
        String apiKey = componentConfig.getString("bing-speech-api-key");
        String locale = componentConfig.getString("locale");
        int sampleRate = componentConfig.getInteger("sample-rate");
        int frameWidth = componentConfig.getInteger("frame-width");
