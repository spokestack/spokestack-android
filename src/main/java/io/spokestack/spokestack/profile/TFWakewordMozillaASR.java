 ...
 * and Mozilla's on-device DeepSpeech (again, via TF Lite) for ASR. Properties
 * related to signal processing are tuned for the "Spokestack" wakeword.
 *
 * <p>
 ...
 *
 * <p>
 * DeepSpeech also requires configuration:
 * </p>
 *
 * <ul>
 *   <li>
 ...
 */
public class TFWakewordMozillaASR implements PipelineProfile {
    @Override
