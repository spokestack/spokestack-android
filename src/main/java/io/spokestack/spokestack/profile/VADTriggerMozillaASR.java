 ...
 * Mozilla's on-device DeepSpeech ASR.
 *
 * <p>
 * DeepSpeech requires extra configuration, which must be added to the pipeline
 * build process separately from this profile:
 * </p>
 *
 * <ul>
 *   <li>
 ...
 */
public class VADTriggerMozillaASR implements PipelineProfile {
    @Override
