...
public class SpeechPipelineTest implements OnSpeechEventListener {
    ...
    public void testBuilder() throws Exception {
        ...
        stages.add("com.pylon.spokestack.SpeechPipelineTest$Stage");
        try (SpeechPipeline pipeline = new SpeechPipeline.Builder()
                .setInputClass("com.pylon.spokestack.SpeechPipelineTest$Input")
    ...
    public void testStartStop() throws Exception {
        final SpeechPipeline pipeline = new SpeechPipeline.Builder()
            .setInputClass("com.pylon.spokestack.SpeechPipelineTest$Input")
            .addStageClass("com.pylon.spokestack.SpeechPipelineTest$Stage")
    ...
    public void testInputFailure() throws Exception {
        SpeechPipeline pipeline = new SpeechPipeline.Builder()
            .setInputClass("com.pylon.spokestack.SpeechPipelineTest$FailInput")
            .addOnSpeechEventListener(this)
            .build();
        pipeline.start();
        pipeline.stop();
    ...
    public void testStageFailure() throws Exception {
        SpeechPipeline pipeline = new SpeechPipeline.Builder()
            .setInputClass("com.pylon.spokestack.SpeechPipelineTest$Input")
            .addStageClass("com.pylon.spokestack.SpeechPipelineTest$FailStage")
            .addOnSpeechEventListener(this)
            .build();
        pipeline.start();
